...
while True:
    ...
    match x:
        case 1:
            sum=0
            n=5
            set1=['MOTHER','ELECTRICITY','MONKEY','EARTH','FRIEND','BUILDING','POTATO','TOMATO','THREE','EVERY','MORNING','NIGHT','GHOST','HUMAN','PICTURE','CLASS','SOMEONE']
            set1=random.choices(set1,k=15)
            set2=set(set1)
            for i in set2:
